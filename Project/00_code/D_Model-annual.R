...
WL_decade_alt1_ext <- lapply(WL_decade_alt1, repeat_rows)
WL_decade_alt2_ext <- lapply(WL_decade_alt2, repeat_rows)
...
mfls_spat3 = spatFilt.bms(X.data = datas_spat, WList = WL_decade_ext, 
                         ...
                         mprior="random", user.int = TRUE)
mfls_spat3_alt1 = spatFilt.bms(X.data = datas_spat, WList = WL_decade_alt1_ext, 
                          burn = 3e+06,iter = 10e+06,
                          nmodel=100, mcmc="bd.int", g="BRIC", 
                          mprior="random", user.int = TRUE)
mfls_spat3_alt2 = spatFilt.bms(X.data = datas_spat, WList = WL_decade_alt2_ext, 
                          burn = 3e+06,iter = 10e+06,
                          nmodel=100, mcmc="bd.int", g="BRIC", 
                          mprior="random", user.int = TRUE)
...
rm(list = setdiff(ls(), c("mfls_base1", "mfls_base2", "mfls_base3",
                          ...
                          "mfls_spat3_alt1", "mfls_spat3_alt2")))
